...
% attenuation using fAxP method, measuring amplitude loss as well
% as phase lag 
...
orid = 2508; % seaz ~ 299   
sta2 = 'AAUS'; % should be MORE attenuated
sta2 = 'GOBA'; % should be MORE attenuated
% sta2 = 'DZEE'; % should be MORE attenuated
sta1 = 'TEND'; % should be LESS attenuated
